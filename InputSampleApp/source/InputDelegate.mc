...
class InputDelegate extends WatchUi.BehaviorDelegate {
    ...
    public function onNextPage() as Boolean {
        System.println("onNextPage got called ...");
    ...
    public function onPreviousPage() as Boolean {
        System.println("onPreviousPage got called ...");
    ...
    public function onMenu() as Boolean {
        System.println("onMenu got called ...");
    ...
    public function onBack() as Boolean {
        System.println("onBack got called ...");
    ...
    public function onNextMode() as Boolean {
        System.println("onNextMode got called ...");
    ...
    public function onPreviousMode() as Boolean {
        System.println("onPreviousMode got called ...");
    ...
    public function onSelect() as Boolean {
        System.println("onSelect got called ...");
    ...
    public function onTap(evt as ClickEvent) as Boolean {
        System.println("onTap got called ...");
    ...
    public function onHold(evt as ClickEvent) as Boolean {
        System.println("onHold got called ...");
    ...
    public function onRelease(evt as ClickEvent) as Boolean {
        System.println("onRelease got called ...");
    ...
    public function onSwipe(evt as SwipeEvent) as Boolean {
        System.println("onSwipe got called ...");
    ...
    public function onKey(evt as KeyEvent) as Boolean {
        System.println("onKey got called ...");
        var key = evt.getKey();
    ...
    public function onKeyPressed(evt as KeyEvent) as Boolean {
        System.println("onKeyPressed got called ...");
    ...
    public function onKeyReleased(evt as KeyEvent) as Boolean {
        System.println("onKeyReleased got called ...");
        var key = getKeyAction(evt.getKey());
        if (key != null) {
    ...
    private function getButton(key as Key) as Button {
        ...
        System.println("[getButton]key=" + key + ", buttonBit=" + buttonBit);
        ...
        if (buttonBit == null || _buttonsPressed == null) {
            ...
            System.println("[getButton]_buttonsPressed=" + _buttonsPressed + ", _buttonsExpected=" + _buttonsExpected);
